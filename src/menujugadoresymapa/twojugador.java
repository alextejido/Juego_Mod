 ...
 * @author Alex
 */
public class twojugador extends javax.swing.JFrame {
...
public void nombre(){
  ...
  String nom=jname.getText();
   ...
   String archivo = "nombre.txt";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("2 PLAYER");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 30, 410, 90));
  ...
  String []nom=new String[1];
    ...
    System.out.println(event);
            ...
            Logger.getLogger(twojugador.class.getName()).log(Level.SEVERE, null, ex);
        }
           /*  FileWriter fw = null;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(twojugador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new twojugador().setVisible(true);
            }
        });
    }
